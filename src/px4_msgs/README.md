...
This library is cloned from the PX4 Autopilot stack. This is done to provide a stable version of the code for the end user utilizing the ACSL FLIGHT STACK. Refer License in this package for distribution information - Giri Mugundan Kumar.
